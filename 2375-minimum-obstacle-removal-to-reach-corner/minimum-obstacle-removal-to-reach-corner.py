class Solution:
    ...
    def minimumObstacles(self, grid):
        ...
        deque_cells =[(0, 0, 0)] # (obstacles, row, col)

        while deque_cells:
            obstacles, row, col = heapq.heappop(deque_cells)
            ...
            for dr, dc in self._directions:
                ...
                if _is_valid(new_row, new_col) and min_obstacles[new_row][
                    ...
                    if grid[new_row][new_col] == 1:
                        ...
                        heapq.heappush(deque_cells,(obstacles + 1, new_row, new_col))
                    else:
                        # If it's an empty cell, keep the obstacle count and push to the front
                        min_obstacles[new_row][new_col] = obstacles
                        heapq.heappush(deque_cells,(obstacles, new_row, new_col))
